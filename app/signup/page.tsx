  ...
  if (success) {
    return (
      <main className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="bg-surface-container-lowest rounded-[1rem] p-10 max-w-md w-full text-center shadow-[0_8px_24px_rgba(92,46,0,0.06)]">
          <div className="text-4xl mb-4">📬</div>
          <h2 className="font-headline text-2xl font-bold italic text-on-surface mb-3">Check your inbox</h2>
  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="bg-surface-container-lowest rounded-[1rem] p-10 max-w-md w-full shadow-[0_8px_24px_rgba(92,46,0,0.06)]">
        ...
        <h1 className="font-headline text-3xl font-bold italic text-on-surface mb-1">Create your account</h1>
        <p className="font-body text-sm text-on-surface-variant mb-8">Start publishing recipes for free.</p>
